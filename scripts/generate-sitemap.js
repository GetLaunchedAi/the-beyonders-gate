...
// Configuration
const CONFIG = {
  baseUrl: 'https://dynamiclifeway.com/',
  ...
  rules: {
    ...
    '/breakthrough-transformation-coaching/': { priority: '0.70', changefreq: 'monthly' },
    '/clarity-goal-setting/': { priority: '0.70', changefreq: 'monthly' },
    '/dynamic-life-way-coaching/': { priority: '0.70', changefreq: 'monthly' },
    '/mindfulness-emotional-resilience/': { priority: '0.70', changefreq: 'monthly' },
